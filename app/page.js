      ...
      <section className="py-16 md:py-24 px-6 text-center bg-gradient-to-b from-blue-50/50 to-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
            Kerajinan Nisan <span className="text-blue-600 underline decoration-blue-200">Kramik & Granit</span> Berkualitas.
          </h2>
          <p className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">
            Melayani pemesanan kustom dengan teknik ukir profesional. Pengiriman aman dan amanah.
          </p>
      ...
      <section id="profil" className="py-16 px-6 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
        <div className="order-2 md:order-1 text-center md:text-left">
          ...
          <p className="text-gray-600 leading-relaxed text-base md:text-lg mb-8">
            Kami mengombinasikan keahlian seni tradisional dengan material tinggi. Detail pekerjaan adalah identitas kami.
          </p>
          <div className="space-y-3 font-bold text-gray-700 text-sm md:text-base">
            <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
              <span className="text-blue-600">✔</span> Bahan Kramik & Granit Pilihan
            </div>
            <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
      ...
      <section id="produk" className="py-20 bg-gray-900 text-white px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-sm md:text-base">Tekan kategori untuk melihat detail</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <Link href="/produk/kramik" className="group bg-gray-800 p-8 md:p-10 rounded-[24px] md:rounded-[32px] hover:bg-white transition-all duration-500">
              ...
              <p className="text-gray-400 text-sm mb-6 group-hover:text-gray-600 italic">Bahan Kramik Mulus & Awet.</p>
